...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = new C02012();
    public static final AbsSavedState EMPTY_STATE = new C02861();
    private final Parcelable mSuperState;

    /* renamed from: android.support.v4.view.AbsSavedState$2 */
    static class C02012 implements ClassLoaderCreator<AbsSavedState> {
        C02012() {
        }
    ...
    static class C02861 extends AbsSavedState {
        C02861() {
            super();
        }
    }
