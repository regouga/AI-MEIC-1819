...
public class ViewCompat {
    ...
    static class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager at(View root) {
            UnhandledKeyEventManager manager = (UnhandledKeyEventManager) root.getTag(C0013R.id.tag_unhandled_key_event_manager);
            if (manager != null) {
                return manager;
            }
            manager = new UnhandledKeyEventManager();
            root.setTag(C0013R.id.tag_unhandled_key_event_manager, manager);
            return manager;
        }
        ...
        private boolean onUnhandledKeyEvent(@NonNull View v, @NonNull KeyEvent event) {
            ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners = (ArrayList) v.getTag(C0013R.id.tag_unhandled_key_listeners);
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View v, @NonNull OnUnhandledKeyEventListenerCompat listener) {
        if (VERSION.SDK_INT >= 28) {
            Map<OnUnhandledKeyEventListenerCompat, OnUnhandledKeyEventListener> viewListeners = (Map) v.getTag(C0013R.id.tag_unhandled_key_listeners);
            if (viewListeners == null) {
                viewListeners = new ArrayMap();
                v.setTag(C0013R.id.tag_unhandled_key_listeners, viewListeners);
            }
        ...
        ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners2 = (ArrayList) v.getTag(C0013R.id.tag_unhandled_key_listeners);
        if (viewListeners2 == null) {
            viewListeners2 = new ArrayList();
            v.setTag(C0013R.id.tag_unhandled_key_listeners, viewListeners2);
        }
