        ...
        public boolean equals(@Nullable Object o) {
            ...
            if (o != null) {
                if (o instanceof Params) {
                    ...
                    if (VERSION.SDK_INT >= 23) {
                        if (this.mBreakStrategy != other.getBreakStrategy() || this.mHyphenationFrequency != other.getHyphenationFrequency()) {
                            return false;
                        }
                    }
                    if (VERSION.SDK_INT >= 18) {
                    ...
                    if (this.mPaint.getTextSize() != other.getTextPaint().getTextSize() || this.mPaint.getTextScaleX() != other.getTextPaint().getTextScaleX() || this.mPaint.getTextSkewX() != other.getTextPaint().getTextSkewX()) {
                        return false;
                    }
                    if (VERSION.SDK_INT >= 21) {
                        if (this.mPaint.getLetterSpacing() != other.getTextPaint().getLetterSpacing() || !TextUtils.equals(this.mPaint.getFontFeatureSettings(), other.getTextPaint().getFontFeatureSettings())) {
                            return false;
                        }
                    }
                    ...
                    if (VERSION.SDK_INT >= 24) {
                        ...
                        if (!this.mPaint.getTextLocale().equals(other.getTextPaint().getTextLocale())) {
                            return false;
                        }
                    }
