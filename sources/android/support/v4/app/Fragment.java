...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner {
    ...
    class C02632 extends FragmentContainer {
        C02632() {
        }
    ...
    class C02643 implements LifecycleOwner {
        C02643() {
        }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        if (!this.mUserVisibleHint && isVisibleToUser && this.mState < 3 && this.mFragmentManager != null) {
            if (isAdded() && this.mIsCreated) {
        ...
        if (fragmentManagerImpl != null) {
            if (fragmentManagerImpl.mHost != null) {
                if (Looper.myLooper() != this.mFragmentManager.mHost.getHandler().getLooper()) {
                    this.mFragmentManager.mHost.getHandler().postAtFrontOfQueue(new C01031());
                    return;
                } else {
    ...
    void instantiateChildFragmentManager() {
        if (this.mHost != null) {
            ...
            this.mChildFragmentManager.attachController(this.mHost, new C02632(), this);
            return;
        }
    ...
    void performCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        this.mViewLifecycleOwner = new C02643();
