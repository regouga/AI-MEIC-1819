...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C01291();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C02672();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C01291 implements ThreadFactory {
    ...
    class C02672 extends WorkerRunnable<Params, Result> {
        C02672() {
        }
