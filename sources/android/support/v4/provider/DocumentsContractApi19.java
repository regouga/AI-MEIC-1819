...
class DocumentsContractApi19 {
    ...
    public static boolean exists(android.content.Context r9, android.net.Uri r10) {
        /*
        r6 = r9.getContentResolver();
        r7 = 0;
        r8 = 0;
        r0 = "document_id";
        r2 = new java.lang.String[]{r0};	 Catch:{ Exception -> 0x002d }
        r3 = 0;
        r4 = 0;
        r5 = 0;
        r0 = r6;
        r1 = r10;
        r0 = r0.query(r1, r2, r3, r4, r5);	 Catch:{ Exception -> 0x002d }
        r7 = r0;
        r0 = r7.getCount();	 Catch:{ Exception -> 0x002d }
    ...
    L_0x002d:
        ...
        android.util.Log.w(r1, r2);	 Catch:{ all -> 0x002b }
        closeQuietly(r7);
        return r8;
        closeQuietly(r7);
        throw r0;
