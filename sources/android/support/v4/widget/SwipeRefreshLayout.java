...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    class C02221 implements AnimationListener {
        C02221() {
        }
    ...
    class C02232 extends Animation {
        C02232() {
        }
    ...
    class C02243 extends Animation {
        C02243() {
        }
    ...
    class C02265 implements AnimationListener {
        C02265() {
        }
    ...
    class C02276 extends Animation {
        C02276() {
        }
    ...
    class C02287 extends Animation {
        C02287() {
        }
    ...
    class C02298 extends Animation {
        C02298() {
        }
    ...
    public SwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        this.mRefreshListener = new C02221();
        this.mAnimateToCorrectPosition = new C02276();
        this.mAnimateToStartPosition = new C02287();
    ...
    private void startScaleUpAnimation(AnimationListener listener) {
        ...
        this.mScaleAnimation = new C02232();
    ...
    void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new C02243();
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        if (overscrollTop < r0.mTotalDragDistance) {
            if (r0.mProgress.getAlpha() > STARTING_PROGRESS_ALPHA) {
    ...
    private void startScaleDownReturnToStartAnimation(int from, AnimationListener listener) {
        ...
        this.mScaleDownToStartAnimation = new C02298();
