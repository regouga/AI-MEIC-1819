...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C02301();
    ...
    private final Runnable mSetIdleRunnable = new C02312();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    /* renamed from: android.support.v4.widget.ViewDragHelper$1 */
    static class C02301 implements Interpolator {
        C02301() {
        }
