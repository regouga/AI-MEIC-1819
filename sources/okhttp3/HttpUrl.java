...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        Builder parse(@Nullable HttpUrl base, String input) {
            ...
            int schemeDelimiterOffset = schemeDelimiterOffset(str, pos2, limit);
            char c2 = '￿';
            if (schemeDelimiterOffset != -1) {
                if (input.regionMatches(true, pos2, "https:", 0, 6)) {
                    ...
                    if (input.regionMatches(true, pos2, "http:", 0, 5)) {
                        ...
                        stringBuilder.append(str.substring(0, schemeDelimiterOffset));
                    ...
                    if (pos2 != limit) {
                        if (str.charAt(pos2) != '#') {
                            ...
                            if (pos < limit || str.charAt(pos) != '?') {
                                ...
                                int c4 = Util.delimiterOffset(str, pos, limit, c);
                                builder.encodedQueryNamesAndValues = HttpUrl.queryStringToNamesAndValues(HttpUrl.canonicalize(input, pos + 1, c4, HttpUrl.QUERY_ENCODE_SET, true, false, true, true, null));
                                pos = c4;
                            }
            ...
            while (true) {
                char charAt;
                int componentDelimiterOffset = Util.delimiterOffset(str, pos2, limit, "@/\\?#");
                if (componentDelimiterOffset != limit) {
                    charAt = str.charAt(componentDelimiterOffset);
                } else {
                    charAt = '￿';
                }
                char c5 = charAt;
                if (!(c5 == c2 || c5 == r10 || c5 == '/' || c5 == '\\')) {
                    switch (c5) {
                        ...
                        case '@':
                            ...
                            if (z2) {
                                ...
                                stringBuilder2.append(HttpUrl.canonicalize(input, pos3, componentDelimiterOffset2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, null));
                                builder.encodedPassword = stringBuilder2.toString();
                            } else {
                                String stringBuilder3;
                                int passwordColonOffset = Util.delimiterOffset(str, pos2, componentDelimiterOffset, ':');
                                ...
                                if (z) {
                                    ...
                                    stringBuilder4.append(builder.encodedUsername);
                                    stringBuilder4.append("%40");
                                    stringBuilder4.append(canonicalUsername);
                                    stringBuilder3 = stringBuilder4.toString();
                                } else {
                                    stringBuilder3 = canonicalUsername;
                                }
                                builder.encodedUsername = stringBuilder3;
                                pos2 = componentDelimiterOffset2;
                                if (pathDelimiterOffset != pos2) {
                                    z2 = true;
                                    componentDelimiterOffset2 = pos2;
                                    builder.encodedPassword = HttpUrl.canonicalize(input, pathDelimiterOffset + 1, pos2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, 1, null);
                                } else {
                                    componentDelimiterOffset2 = pos2;
                ...
                c = '#';
                pos2 = pos2;
                int portColonOffset = portColonOffset(str, pos2, componentDelimiterOffset3);
                if (portColonOffset + 1 < componentDelimiterOffset3) {
                    builder.host = canonicalizeHost(str, pos2, portColonOffset);
                    builder.port = parsePort(str, portColonOffset + 1, componentDelimiterOffset3);
                    if (builder.port == -1) {
                        StringBuilder stringBuilder5 = new StringBuilder();
                        stringBuilder5.append("Invalid URL port: \"");
                        stringBuilder5.append(str.substring(portColonOffset + 1, componentDelimiterOffset3));
                ...
                stringBuilder5.append("Invalid URL host: \"");
                stringBuilder5.append(str.substring(pos2, portColonOffset));
                stringBuilder5.append('\"');
                throw new IllegalArgumentException(stringBuilder5.toString());
                httpUrl = base;
                c3 = '#';
        ...
        private boolean isDot(String input) {
            if (!input.equals(FileUtils.HIDDEN_PREFIX)) {
    ...
    public List<String> encodedPathSegments() {
        ...
        while (i < pathEnd2) {
            i++;
            int segmentEnd = Util.delimiterOffset(this.url, i, pathEnd2, '/');
