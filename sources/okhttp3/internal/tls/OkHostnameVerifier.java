...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    public boolean verifyHostname(String hostname, String pattern) {
        if (hostname != null && hostname.length() != 0 && !hostname.startsWith(FileUtils.HIDDEN_PREFIX)) {
            if (!hostname.endsWith("..")) {
                if (pattern != null && pattern.length() != 0 && !pattern.startsWith(FileUtils.HIDDEN_PREFIX)) {
                    if (!pattern.endsWith("..")) {
