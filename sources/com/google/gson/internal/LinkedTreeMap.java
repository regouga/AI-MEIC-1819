...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C02381();
    ...
    static class C02381 implements Comparator<Comparable> {
        C02381() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C03151 extends LinkedTreeMapIterator<Entry<K, V>> {
            C03151() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C03161 extends LinkedTreeMapIterator<K> {
            C03161() {
                super();
            }
