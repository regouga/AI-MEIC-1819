...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
        ...
        return new Adapter(gson, keyAndValueTypes[0], keyAdapter, keyAndValueTypes[1], gson2.getAdapter(TypeToken.get(keyAndValueTypes[1])), mapTypeAdapterFactory.constructorConstructor.get(typeToken));
    }
    ...
    private TypeAdapter<?> getKeyAdapter(Gson context, Type keyType) {
        ...
        if (keyType != Boolean.TYPE) {
            if (keyType != Boolean.class) {
                adapter = context.getAdapter(TypeToken.get(keyType));
                return adapter;
            }
        }
