...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C02371();
    ...
    static class C02371 implements Comparator<Comparable> {
        C02371() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C03131 extends LinkedTreeMapIterator<Entry<K, V>> {
            C03131() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C03141 extends LinkedTreeMapIterator<K> {
            C03141() {
                super();
            }
